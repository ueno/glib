 ...
 * @G_INPUT_METHOD_STYLING_NORMAL:
 * @G_INPUT_METHOD_STYLING_UNDERLINE:
 * @G_INPUT_METHOD_STYLING_SELECTED:
 * @G_INPUT_METHOD_STYLING_SECONDARY:
 *
 * Styling attributes for #GInputMethodEngine::preedit_text.
 */
typedef enum {
  G_INPUT_METHOD_STYLING_NORMAL,
  G_INPUT_METHOD_STYLING_UNDERLINE,
...
/**
 * GInputMethodPurpose:
 * @G_INPUT_METHOD_PURPOSE_FREE_FORM:
 * @G_INPUT_METHOD_PURPOSE_ALPHA:
 * @G_INPUT_METHOD_PURPOSE_DIGITS:
 * @G_INPUT_METHOD_PURPOSE_NUMBER:
 * @G_INPUT_METHOD_PURPOSE_PHONE:
 * @G_INPUT_METHOD_PURPOSE_URL:
 * @G_INPUT_METHOD_PURPOSE_EMAIL:
 * @G_INPUT_METHOD_PURPOSE_NAME:
 * @G_INPUT_METHOD_PURPOSE_PASSWORD:
 * @G_INPUT_METHOD_PURPOSE_PIN:
 *
 * Describes primary purpose of the input widget.
 */
typedef enum {
  G_INPUT_METHOD_PURPOSE_FREE_FORM = 0,
  G_INPUT_METHOD_PURPOSE_ALPHA = 1,
  G_INPUT_METHOD_PURPOSE_DIGITS = 2,
  G_INPUT_METHOD_PURPOSE_NUMBER = 3,
  G_INPUT_METHOD_PURPOSE_PHONE = 4,
  G_INPUT_METHOD_PURPOSE_URL = 5,
  G_INPUT_METHOD_PURPOSE_EMAIL = 6,
  G_INPUT_METHOD_PURPOSE_NAME = 7,
  G_INPUT_METHOD_PURPOSE_PASSWORD = 8,
  G_INPUT_METHOD_PURPOSE_PIN = 9
} GInputMethodPurpose;

/**
 * GInputMethodHints:
 * @G_INPUT_METHOD_HINT_NONE:
 * @G_INPUT_METHOD_HINT_SPELLCHECK:
 * @G_INPUT_METHOD_HINT_NO_SPELLCHECK:
 * @G_INPUT_METHOD_HINT_WORD_COMPLETION:
 * @G_INPUT_METHOD_HINT_LOWERCASE:
 * @G_INPUT_METHOD_HINT_UPPERCASE_CHARS:
 * @G_INPUT_METHOD_HINT_UPPERCASE_WORDS:
 * @G_INPUT_METHOD_HINT_UPPERCASE_SENTENCES:
 * @G_INPUT_METHOD_HINT_INHIBIT_OSK:
 *
 * Describes hints that might be taken into account by input methods
 * or applications.
 */
typedef enum {
  G_INPUT_METHOD_HINT_NONE = 0,
  G_INPUT_METHOD_HINT_SPELLCHECK = 1,
  G_INPUT_METHOD_HINT_NO_SPELLCHECK = 2,
  G_INPUT_METHOD_HINT_WORD_COMPLETION = 4,
  G_INPUT_METHOD_HINT_LOWERCASE = 8,
  G_INPUT_METHOD_HINT_UPPERCASE_CHARS = 16,
  G_INPUT_METHOD_HINT_UPPERCASE_WORDS = 32,
  G_INPUT_METHOD_HINT_UPPERCASE_SENTENCES = 64,
  G_INPUT_METHOD_HINT_INHIBIT_OSK = 128,
} GInputMethodHints;
